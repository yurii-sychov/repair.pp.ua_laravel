<div class="row">
	<div class="col-xl-4 col-lg-5">
		<div class="card text-center">
			<div class="card-body">
				<img src="/admin/assets/images/users/avatar-1.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
				<h4 class="mb-0 mt-2">
					@auth
		...
		<div class="card">
			<div class="card-body">
				<div class="dropdown float-end">
					<a href="pages-profile-2.html#" class="dropdown-toggle arrow-none card-drop" data-bs-toggle="dropdown" aria-expanded="false">
				...
				<div class="inbox-widget">
					<div class="inbox-item">
						...
						<p class="inbox-item-date">
							<a href="pages-profile-2.html#" class="btn btn-sm btn-link text-info font-13"> Reply </a>
						</p>
					</div>
					<div class="inbox-item">
		...
		<div class="card">
			<div class="card-body">
				<ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
					...
					<li class="nav-item">
						<a href="pages-profile-2.html#timeline" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0">
							Timeline
						</a>
					</li>
					<li class="nav-item">
						<a href="pages-profile-2.html#settings" data-bs-toggle="tab" aria-expanded="false" class="nav-link rounded-0 active">
							Settings
						</a>
					</li>
				</ul>
				<div class="tab-content">
						...
						<div class="table-responsive">
							<table class="table table-borderless table-nowrap mb-0">
								...
								<tbody>
									<tr>
										<td>1</td>
										<td><img src="/admin/assets/images/users/avatar-2.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Halette Boivin</td>
									...
									<tr>
										<td>2</td>
										<td><img src="/admin/assets/images/users/avatar-3.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Durandana Jolicoeur</td>
									...
									<tr>
										<td>3</td>
										<td><img src="/admin/assets/images/users/avatar-4.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Lucas Sabourin</td>
									...
									<tr>
										<td>4</td>
										<td><img src="/admin/assets/images/users/avatar-6.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Donatien Brunelle</td>
									...
									<tr>
										<td>5</td>
										<td><img src="/admin/assets/images/users/avatar-5.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Karel Auberjo</td>
					...
					<div class="tab-pane show" id="timeline">
						...
						<div class="border border-light rounded p-2 mb-3">
							<div class="d-flex">
								<img class="me-2 rounded-circle" src="/admin/assets/images/users/avatar-3.jpg" alt="Generic placeholder image" height="32">
								<div>
							...
							<img src="/admin/assets/images/small/small-1.jpg" alt="post-img" class="rounded me-1" height="60" />
							<img src="/admin/assets/images/small/small-2.jpg" alt="post-img" class="rounded me-1" height="60" />
							<img src="/admin/assets/images/small/small-3.jpg" alt="post-img" class="rounded" height="60" />
						...
						<div class="border border-light rounded p-2 mb-3">
							<div class="d-flex">
								<img class="me-2 rounded-circle" src="/admin/assets/images/users/avatar-4.jpg" alt="Generic placeholder image" height="32">
								<div>
							...
							<div class="mx-n2 p-2 mt-3 bg-light">
								<div class="d-flex">
									...
									<div>
										...
										<div class="d-flex mt-3">
											<a class="pe-2" href="pages-profile-2.html#">
												<img src="/admin/assets/images/users/avatar-4.jpg" class="rounded-circle" alt="Generic placeholder image" height="32">
											</a>
											<div>
								...
								<div class="d-flex mt-2">
									<a class="pe-2" href="pages-profile-2.html#">
										<img src="/admin/assets/images/users/avatar-1.jpg" class="rounded-circle" alt="Generic placeholder image" height="32">
									</a>
									<div class="w-100">
						...
						<div class="border border-light p-2 mb-3">
							<div class="d-flex">
								<img class="me-2 rounded-circle" src="/admin/assets/images/users/avatar-6.jpg" alt="Generic placeholder image" height="32">
								<div>
					...
					<div class="tab-pane active" id="settings">
						<form id="formProfile">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="firstname" placeholder="Enter first name" value="{{ $user->name }}" name="name">
									</div>
								</div>
								<div class="col-md-6">
									<div class="mb-3">
										<label for="lastname" class="form-label">Last Name</label>
										<input type="text" class="form-control" id="lastname" placeholder="Enter last name" value="{{ $user->surname }}" name="surname">
									</div>
								</div> <!-- end col -->
							</div> <!-- end row -->
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mb-3">
										...
										<input type="email" class="form-control" id="useremail" placeholder="Enter email" value="{{ $user->email }}" name="email">
							...
							<div class="text-end">
								<button type="submit" class="btn btn-success mt-2" onClick="update_profile_ajax(event)"><i class="mdi mdi-content-save"></i> Save</button>
							</div>
						</form>
					</div>
...
<script>
 function update_profile_ajax(event) {
  event.preventDefault();

  const form = $("#formProfile");

  $.ajax({
    url: "/profile/update_profile_ajax/",
    method: "POST",
    headers: {
