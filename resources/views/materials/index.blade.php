<div class="row">
	<div class="col-lg-12">
		<div class="card mb-3">
			<h3 class="card-header text-primary">Матеріальні ресурси
			...
			<div class="card-body">
				<div id="cardCollpase" class="collapse show">
					<div class="row mb-2">
						<div class="col-lg-12">
							<a href="/materials/create" class="btn btn-primary mb-1">
								...
								<tbody>
									@foreach ($results as $item)
										<tr class="text-center">
											...
											<td>{{ $item->r3_id ? $item->r3_id : 'NULL' }}</td>
											<td>{{ $item->name }}</td>
											<td>{{ $item->unit }}</td>
											...
											<td>
												<form action="/materials/{{ $item->id }}" method="POST">
													<a href="/materials/{{ $item->id }}" class="btn btn-outline-info btn-sm my-1">
														<i class="mdi mdi-eye"></i>
													</a>
													<a href="/materials/{{ $item->id }}/edit" class="btn btn-outline-success btn-sm my-1">
