<div class="row">
	<div class="col-lg-12">
		<div class="card mb-3">
			<h3 class="card-header text-primary">Людські ресурси
			...
			<div class="card-body">
				<div id="cardCollpase" class="collapse show">
					<div class="row mb-2">
						<div class="col-lg-12">
							<a href="/workers/create" class="btn btn-primary mb-1">
								...
								<tbody>
									@foreach ($results as $item)
										<tr class="text-center">
											...
											<td>
												<form action="/workers/{{ $item->id }}" method="POST">
													<a href="/workers/{{ $item->id }}" class="btn btn-outline-info btn-sm my-1">
														<i class="mdi mdi-eye"></i>
													</a>
													<a href="/workers/{{ $item->id }}/edit" class="btn btn-outline-success btn-sm my-1">
