...
class WorkersController extends Controller
{
	...
	public function index()
	{
		$data = [];
		$data['page'] = 'index';
		$data['title_page'] = 'Довідник ресурсів';
		$data['content'] = 'workers/index';
		$data['results'] = Worker::paginate(5);
	...
	public function create()
	{
		$data = [];
		$data['page'] = 'create';
		$data['title_page'] = 'Сторінка створення людського ресурсу';
		$data['content'] = 'workers/form';
		return view('layouts/admin_layout', $data);
	}
	...
	{
		$result = Worker::find($id);

		$data = [];
		$data['page'] = 'edit';
		$data['title_page'] = 'Сторінка редагування людського ресурсу';
		$data['content'] = 'workers/form';
