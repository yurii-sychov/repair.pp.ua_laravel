...
class MaterialsController extends Controller
{
	...
	public function index()
	{
		$data = [];
		$data['page'] = 'index';
		$data['title_page'] = 'Довідник матеріалів';
		$data['content'] = 'materials/index';
		$data['results'] = Material::paginate(5);
	...
	public function create()
	{
		$data = [];
		$data['page'] = 'create';
		$data['title_page'] = 'Сторінка створення матеріального ресурсу';
		$data['content'] = 'materials/form';
		return view('layouts/admin_layout', $data);
	}
	...
	public function edit($id)
	{
		...
		$data = [];
		$data['page'] = 'edit';
		$data['title_page'] = 'Сторінка редагування матеріального ресурсу';
		$data['content'] = 'materials/form';
